...
class DummyController extends Controller
{
    ...
    public function count(){
        try {
            $response['totalRecords'] = DummyModel::count();
            if($response == 0){
    ...
    {   
        ...
        try {
            ...
            if ($validator->fails()) {
                ...
                $data = DummyModel::where('id',$request->id)
                ->update([
    ...
    public function change(Request $request){
        ...
        try {
            if($request->password != $request->retype_password){
                ...
                DummyModel::where('id',$request->id)
                ->update([
