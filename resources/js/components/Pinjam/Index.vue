                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Barang</label>
                                                    <select class="form-control" v-model="barang_id">
...
export default {
    ...
    methods: {
        ...
        getData: function(){
            let url = 'api/pinjam/table?s='+this.isScroll;
            axios.get(url).then(response => {
                if(response.data !== 'empty'){
        ...
        getDataBarang: function(){
            let url = 'api/pinjam/getBarangAll';
            axios.get(url).then(response => {
                if(response.data !=='empty'){
                    this.optionsBarang = response.data;
                    // console.log(this.optionsBarang);
                }
            }).catch(e => console.log(e));
        },
